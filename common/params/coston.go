...
var coston = Network{
	...
	Contracts: ContractAddresses{
		...
		// The previous deployment is kept as Old* only because the epoch-4253 test fixture
		// (TestCalculateResults) replays voter registrations emitted by the old contracts.
