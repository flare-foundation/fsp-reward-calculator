...
// CalculateRegistrationWeight is a paid mutator transaction binding the contract method 0x48bee227.
//
// Solidity: function calculateRegistrationWeight(address _voter, uint32 _rewardEpochId, uint256 _votePowerBlockNumber) returns(uint256 _registrationWeight)
func (_Calculator *CalculatorTransactor) CalculateRegistrationWeight(opts *bind.TransactOpts, _voter common.Address, _rewardEpochId uint32, _votePowerBlockNumber *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function calculateRegistrationWeight(address _voter, uint32 _rewardEpochId, uint256 _votePowerBlockNumber) returns(uint256 _registrationWeight)
func (_Calculator *CalculatorSession) CalculateRegistrationWeight(_voter common.Address, _rewardEpochId uint32, _votePowerBlockNumber *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function calculateRegistrationWeight(address _voter, uint32 _rewardEpochId, uint256 _votePowerBlockNumber) returns(uint256 _registrationWeight)
func (_Calculator *CalculatorTransactorSession) CalculateRegistrationWeight(_voter common.Address, _rewardEpochId uint32, _votePowerBlockNumber *big.Int) (*types.Transaction, error) {
	return _Calculator.Contract.CalculateRegistrationWeight(&_Calculator.TransactOpts, _voter, _rewardEpochId, _votePowerBlockNumber)
}
...
// FilterVoterRegistrationInfo is a free log retrieval operation binding the contract event 0xc49a5cabcc0776ace8cfd024e155bc303ee5e492b29d59f1ff7dbafa0b34a04b.
//
// Solidity: event VoterRegistrationInfo(address indexed voter, uint32 indexed rewardEpochId, address delegationAddress, uint16 delegationFeeBIPS, uint256 wNatWeight, uint256 wNatCappedWeight, bytes20[] nodeIds, uint256[] nodeWeights)
func (_Calculator *CalculatorFilterer) FilterVoterRegistrationInfo(opts *bind.FilterOpts, voter []common.Address, rewardEpochId []uint32) (*CalculatorVoterRegistrationInfoIterator, error) {
...
// WatchVoterRegistrationInfo is a free log subscription operation binding the contract event 0xc49a5cabcc0776ace8cfd024e155bc303ee5e492b29d59f1ff7dbafa0b34a04b.
//
// Solidity: event VoterRegistrationInfo(address indexed voter, uint32 indexed rewardEpochId, address delegationAddress, uint16 delegationFeeBIPS, uint256 wNatWeight, uint256 wNatCappedWeight, bytes20[] nodeIds, uint256[] nodeWeights)
func (_Calculator *CalculatorFilterer) WatchVoterRegistrationInfo(opts *bind.WatchOpts, sink chan<- *CalculatorVoterRegistrationInfo, voter []common.Address, rewardEpochId []uint32) (event.Subscription, error) {
...
// ParseVoterRegistrationInfo is a log parse operation binding the contract event 0xc49a5cabcc0776ace8cfd024e155bc303ee5e492b29d59f1ff7dbafa0b34a04b.
//
// Solidity: event VoterRegistrationInfo(address indexed voter, uint32 indexed rewardEpochId, address delegationAddress, uint16 delegationFeeBIPS, uint256 wNatWeight, uint256 wNatCappedWeight, bytes20[] nodeIds, uint256[] nodeWeights)
