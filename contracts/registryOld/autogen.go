...
// GetRegisteredVotersAndNormalisedWeights is a free data retrieval call binding the contract method 0xb9111169.
//
// Solidity: function getRegisteredVotersAndNormalisedWeights(uint256 _rewardEpochId) view returns(address[] _voters, uint16[] _normalisedWeights)
func (_Registry *RegistryCaller) GetRegisteredVotersAndNormalisedWeights(opts *bind.CallOpts, _rewardEpochId *big.Int) (struct {
	Voters            []common.Address
	NormalisedWeights []uint16
}, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "getRegisteredVotersAndNormalisedWeights", _rewardEpochId)
	...
	outstruct.NormalisedWeights = *abi.ConvertType(out[1], new([]uint16)).(*[]uint16)
...
//
// Solidity: function getRegisteredVotersAndNormalisedWeights(uint256 _rewardEpochId) view returns(address[] _voters, uint16[] _normalisedWeights)
func (_Registry *RegistrySession) GetRegisteredVotersAndNormalisedWeights(_rewardEpochId *big.Int) (struct {
	Voters            []common.Address
	NormalisedWeights []uint16
}, error) {
	return _Registry.Contract.GetRegisteredVotersAndNormalisedWeights(&_Registry.CallOpts, _rewardEpochId)
}

// GetRegisteredVotersAndNormalisedWeights is a free data retrieval call binding the contract method 0xb9111169.
//
// Solidity: function getRegisteredVotersAndNormalisedWeights(uint256 _rewardEpochId) view returns(address[] _voters, uint16[] _normalisedWeights)
func (_Registry *RegistryCallerSession) GetRegisteredVotersAndNormalisedWeights(_rewardEpochId *big.Int) (struct {
	Voters            []common.Address
	NormalisedWeights []uint16
}, error) {
	return _Registry.Contract.GetRegisteredVotersAndNormalisedWeights(&_Registry.CallOpts, _rewardEpochId)
...
// GetRegisteredVotersAndRegistrationWeights is a free data retrieval call binding the contract method 0x28be8e3a.
//
// Solidity: function getRegisteredVotersAndRegistrationWeights(uint256 _rewardEpochId) view returns(address[] _voters, uint256[] _registrationWeights)
func (_Registry *RegistryCaller) GetRegisteredVotersAndRegistrationWeights(opts *bind.CallOpts, _rewardEpochId *big.Int) (struct {
	Voters              []common.Address
	RegistrationWeights []*big.Int
}, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "getRegisteredVotersAndRegistrationWeights", _rewardEpochId)
	...
	outstruct.Voters = *abi.ConvertType(out[0], new([]common.Address)).(*[]common.Address)
	outstruct.RegistrationWeights = *abi.ConvertType(out[1], new([]*big.Int)).(*[]*big.Int)
...
//
// Solidity: function getRegisteredVotersAndRegistrationWeights(uint256 _rewardEpochId) view returns(address[] _voters, uint256[] _registrationWeights)
func (_Registry *RegistrySession) GetRegisteredVotersAndRegistrationWeights(_rewardEpochId *big.Int) (struct {
	Voters              []common.Address
	RegistrationWeights []*big.Int
}, error) {
	return _Registry.Contract.GetRegisteredVotersAndRegistrationWeights(&_Registry.CallOpts, _rewardEpochId)
}

// GetRegisteredVotersAndRegistrationWeights is a free data retrieval call binding the contract method 0x28be8e3a.
//
// Solidity: function getRegisteredVotersAndRegistrationWeights(uint256 _rewardEpochId) view returns(address[] _voters, uint256[] _registrationWeights)
func (_Registry *RegistryCallerSession) GetRegisteredVotersAndRegistrationWeights(_rewardEpochId *big.Int) (struct {
	Voters              []common.Address
	RegistrationWeights []*big.Int
}, error) {
	return _Registry.Contract.GetRegisteredVotersAndRegistrationWeights(&_Registry.CallOpts, _rewardEpochId)
...
// GetVoterNormalisedWeight is a free data retrieval call binding the contract method 0x6ddcd4bc.
//
// Solidity: function getVoterNormalisedWeight(address _voter, uint256 _rewardEpochId) view returns(uint16 _normalisedWeight)
func (_Registry *RegistryCaller) GetVoterNormalisedWeight(opts *bind.CallOpts, _voter common.Address, _rewardEpochId *big.Int) (uint16, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "getVoterNormalisedWeight", _voter, _rewardEpochId)
...
//
// Solidity: function getVoterNormalisedWeight(address _voter, uint256 _rewardEpochId) view returns(uint16 _normalisedWeight)
func (_Registry *RegistrySession) GetVoterNormalisedWeight(_voter common.Address, _rewardEpochId *big.Int) (uint16, error) {
	return _Registry.Contract.GetVoterNormalisedWeight(&_Registry.CallOpts, _voter, _rewardEpochId)
}

// GetVoterNormalisedWeight is a free data retrieval call binding the contract method 0x6ddcd4bc.
//
// Solidity: function getVoterNormalisedWeight(address _voter, uint256 _rewardEpochId) view returns(uint16 _normalisedWeight)
func (_Registry *RegistryCallerSession) GetVoterNormalisedWeight(_voter common.Address, _rewardEpochId *big.Int) (uint16, error) {
	return _Registry.Contract.GetVoterNormalisedWeight(&_Registry.CallOpts, _voter, _rewardEpochId)
}
